...
// Check and assign values safely
$profile_visibility = isset($user['profile_visibility']) ? $user['profile_visibility'] : 0; // Default to 0 if not set
?>
...
<head>
    ...
    <style>
        ...
        .back-arrow {
            ...
            top: 20px;
            font-size: 24px;
            color: #0c45f1; /* Arrow color */
            text-decoration: none;
            transition: color 0.3s;
        }

        .back-arrow:hover {
            color: #2b80ff; /* Arrow hover color */
        }
    </style>
</head>
...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <label>
                <input type="checkbox" id="profile-visibility" name="profile_visibility" <?php echo ($profile_visibility ? 'checked' : ''); ?>>
